...
public class ChatAppController {
	...
	private ServerGUI<IChatroom, IInitUser, IChatUser> view;
	...
	public ChatAppController() {
		// set the view field
		view = new ServerGUI<IChatroom, IInitUser,IChatUser>(new IView2ModelAdapter<IChatroom, IInitUser, IChatUser>() {
			/**
