...
public class ServerGUI<Room, Usr, ChatUsr, TmRm> {
	...
	public void setServerWindow(ServerWindow value) {
		this.serverWindow = value;
	}
	 ...
	 */
	public ServerGUI(IView2ModelAdapter<Room, Usr, ChatUsr> modelAdapter) {
		initialize();
	 ...
	 */
	public ServerWindow<ChatUsr, TmRm> makeChatRoom(
			IServerWindow2World<ChatUsr> mv2mmAdapt) {

		ServerWindow<ChatUsr, TmRm> cw = new ServerWindow<ChatUsr, TmRm>(
				mv2mmAdapt);
