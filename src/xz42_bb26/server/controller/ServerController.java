...
public class ServerController {
	...
	public ServerController() {
		// set the view field
		view = new ServerGUI<IChatroom, IInitUser, ChatUserEntity, TeamRoom>(
				new IView2ModelAdapter<IChatroom, IInitUser, ChatUserEntity>() {
					/**
		...
		model = new ServerModel(
				new IModel2ViewAdapter<IInitUser, IChatUser, IChatroom, ChatUserEntity, TeamRoom>() {
					 ...
					 */
					public IServerRoom2WorldAdapter<ChatUserEntity, TeamRoom> makeChatRoom(
							ServerRoom serverRoom) {
						/**
						 * Factory method makes a new mini-view and installs the 
						 * mini-View2Model adapter in it.
						 */
						ServerWindow<ChatUserEntity, TeamRoom> cw = view
								.makeChatRoom(new IServerWindow2World<ChatUserEntity>() {
									...
									public void createTeam(ChatUserEntity member) {
										serverRoom.setUserInvisible(member
												.getChatUser());
										serverRoom.addTeam(model.createTeam(
												serverRoom.getMe(), member));
									}
						...
						return new IServerRoom2WorldAdapter<ChatUserEntity, TeamRoom>() {
							...
							public void refreshList(
									Collection<ChatUserEntity> users) {
							...
							@Override
							public void display(
									Supplier<Component> containerSupplier) {
							...
							public void refreshTeam(
									Collection<TeamRoom> collection) {
