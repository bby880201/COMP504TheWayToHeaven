...
import xz42_bb26.server.model.ChatAppMainModel;
import xz42_bb26.server.model.IModel2ViewAdapter;
import xz42_bb26.server.model.chatroom.ChatroomWithAdapter;
import xz42_bb26.server.model.chatroom.IChatRoom2WorldAdapter;
import xz42_bb26.server.view.IView2ModelAdapter;
import xz42_bb26.server.view.MainGUI;
...
public class ChatAppController {
	...
	private MainGUI<IChatroom, IChatUser> view;
	...
	public ChatAppController() {
		// set the view field
		view = new MainGUI<IChatroom, IChatUser>(new IView2ModelAdapter<IChatroom, IChatUser>() {
			/**
		...
		// set the model field
		model = new ChatAppMainModel(new IModel2ViewAdapter<IChatUser>() {
