...
public class ChatAppController {
	...
	public ChatAppController() {
		// set the view field
		view = new MainGUI<IChatroom, IInitUser, ChatUserEntity>(
		...
		// set the model field
		model = new ChatAppMainModel(
				new IModel2ViewAdapter<IInitUser, IChatUser, IChatroom, ChatUserEntity>() {
					 ...
					 */
					public IChatRoom2WorldAdapter<ChatUserEntity> makeChatRoom(
							ChatroomWithAdapter chatRoom) {
						/**
						 * Factory method makes a new mini-view and installs the 
						 * mini-View2Model adapter in it.
						 */
						ChattingWindow<ChatUserEntity> cw = view
								.makeChatRoom(new IChatWindow2Model<ChatUserEntity>() {
